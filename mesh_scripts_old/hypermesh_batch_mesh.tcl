...
# deck for ANSYS. Intended to be called once per parameter configuration
# from a Python driver script (see fea_scripts/ for the ANSYS side).
#
# Usage (from HyperMesh -batch or hw_tcl shell):
#   hm_tcl_script hypermesh_batch_mesh.tcl <input_geom.stp> <element_size_mm> <output.cdb>
